...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "type_name": "Koniq10k",
        "ckpt_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed20/",
        "saved_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed20/", # directory for saving checkpoint
        "log_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed20/",
