...
if __name__ == '__main__':
    ...
    # 测试集
    parser.add_argument('--test_features_path', type=str, default='./Datasets/X101-features-little/X101_grid_feats_coco_test.hdf5')
    parser.add_argument('--test_annotation_folder', type=str, default='./Datasets/m2_annotations/image_info_test2014.json')

    parser.add_argument('--languege_model_path', type=str, default='save_language_models/bert_language_best_test_at119.pth')
    # 模型参数

    parser.add_argument('--models_path', type=list, default=[
        'save_transformer_models/seed1234/transformers/rstnet_best_test.pth',
        'save_transformer_models/seed1234/transformers/rstnet_best.pth',
        'save_transformer_models/seed1234/transformers/rstnet_best_test.pth',
        'save_transformer_models/seed1234/transformers/rstnet_best.pth'
    ])
    ...
    decoder = TransformerDecoderLayer(len(text_field.vocab), 89, 3, text_field.vocab.stoi['<pad>'], language_model_path=args.languege_model_path)
