...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "ckpt_path": "./output/learning_rate_6_argimg/Koniq10k/koniq10k-base_s20/epoch21.pt",  # directory for saving checkpoint
        "log_path": "./output/log/",
    ...
    if config.dataset_name == 'kadid10k':
        from data.kadid10k.kadid10k import Kadid10k_Pre, Kadid10k
    ...
    result_df.to_csv('./ensemble/learning_rate_6_argimg.csv', index=False)
