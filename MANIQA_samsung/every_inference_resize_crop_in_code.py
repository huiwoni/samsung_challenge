...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "ckpt_path": "./output/learning_rate_6_resize_crop_in_code/Koniq10k/koniq10k-base_s20/epoch6.pt",  # directory for saving checkpoint
        "log_path": "./output/log/",
        "log_file": "koniq10k-base_s206.log",
        "tensorboard_path": "./output/tensorboard/"
    })
    if config.dataset_name == 'koniq10k':
        from data.koniq10k.koniq10k import Koniq10k_inference_resize_crop
        ...
        Dataset = Koniq10k_inference_resize_crop
    ...
    result_df.to_csv('./ensemble/learning_rate_6_resize_crop_in_code.csv', index=False)
