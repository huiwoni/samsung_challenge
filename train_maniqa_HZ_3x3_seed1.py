...
from models.maniqa import MANIQA, MANIQA_3x3, MANIQA_5x5
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # KONIQ-10K
        "koniq10k_path": "./IQA_dataset/train/",                        # samsung dataset
        "koniq10k_HZ_path": "./IQA_dataset/train_log_HZ/",              # frequency image
        "koniq10k_label": "./data/koniq10k/train_jpg.csv",              # annotation
        ...
        "type_name": "Koniq10k",
        "ckpt_path": "./output/learning_rate_6_HZ_RGB_3x3_seed1_/",
        "log_path": "./output/learning_rate_6_HZ_RGB_3x3_seed1_/",
