...
from models.maniqa import MANIQA_5x5
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "kadid10k_label": "./data/kadid10k/kadid10k_label.csv",

        # KONIQ-10K
        "koniq10k_path": "./IQA_dataset/train/",
        "koniq10k_HZ_path": "./IQA_dataset/train_log_HZ/",
        "koniq10k_label": "./data/koniq10k/train_jpg.csv",
        ...
        "type_name": "Koniq10k",
        "ckpt_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed3456/",
        "saved_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed3456/", # directory for saving checkpoint
        "log_path": "./output/learning_rate_6_all_HZ_RGB_5*5conv_seed3456/",
        "log_file": "koniq10k-base_s206.log",
        "tensorboard_path": "./output/tensorboard/"
    })

    config.log_file = config.model_name + "koniq10k-base_s206.log"
    ...
    if config.dataset_name == 'kadid10k':
        ...
        from data.koniq10k.koniq10k import Koniq10k_HZ
    ...
    # model defination
    net = MANIQA_5x5(embed_dim=config.embed_dim, num_outputs=config.num_outputs, dim_mlp=config.dim_mlp,
