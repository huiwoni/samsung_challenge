...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "type_name": "Koniq10k",
        "ckpt_path": "./output/learning_rate_6_resize_crop_in_code/",  # directory for saving checkpoint
        "log_path": "./output/learning_rate_6_resize_crop_in_code/",
    ...
    if config.dataset_name == 'kadid10k':
        ...
        from data.koniq10k.koniq10k import Koniq10k_resize_crop
