...
config = Config({
    ...
    'db_path': './dataset/',      # root path of database
    'txt_file_name': './annotation/train_jpg.txt',                # list of images in the database
    'train_size': 0.9,                                          # train/vaildation separation ratio
    ...
    'snap_path': './weights/test',               # directory for saving checkpoint
