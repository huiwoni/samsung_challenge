...
from utils.process import split_dataset_kadid10k, split_dataset_koniq10k, split_dataset_koniq10k_arg
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # KONIQ-10K
        "koniq10k_path": "./IQA_dataset/train_arg/",
        ...
        "type_name": "Koniq10k",
        "ckpt_path": "./output/learning_rate_6_aug_seed719_/",  # directory for saving checkpoint
        "log_path": "./output/learning_rate_6_aug_seed719_/",
        "log_file": ".log",
        "tensorboard_path": "./output/tensorboard/"
    })

    config.log_file = config.model_name + "6.log"
    ...
    if config.dataset_name == 'kadid10k':
        ...
        from data.koniq10k.koniq10k import Koniq10k_arg

        train_name, val_name = split_dataset_koniq10k_arg(
    ...
    for epoch in range(0, config.n_epoch):
        ...
        if (epoch + 1) % config.val_freq == 0:
            ...
            if rho_s + rho_p > main_score:
                ...
                # save weights
                model_name = "epoch{}1.pt".format(epoch + 1)
