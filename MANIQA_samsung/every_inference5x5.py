...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        "ckpt_path": "./output/learning_rate_6_mscn_RGB_5x5_seed49/Koniq10k/koniq10k-base_s20/epoch5.pt",  # directory for saving checkpoint
        "log_path": "./output/log/",
    ...
    result_df.to_csv('./result/learning_rate_6_mscn_RGB_5x5_seed49.csv', index=False)
