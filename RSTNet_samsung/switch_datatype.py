...
def main(args):
    ...
    for data_split in data_splits:
        ...
        for i in tqdm(range(len(file_names))):
            ...
            image_id = file_name
            saved_file_path = os.path.join(args.dir_to_save_float16_feats, data_split, str(image_id[:-4]) + '.npy')
            np.save(saved_file_path, data16)


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='swith the data type of X101-test2015')
    #    parser.add_argument('--dir_to_raw_feats', type=str, default='./Datasets/X101-X101-test2015/', help='big data')
    #    parser.add_argument('--dir_to_float16_feats', type=str, default='./Datasets/X101-X101-test2015-float16', help='little data')
    ########################################################################
    parser.add_argument('--dir_to_save_feats', type=str, default='./Datasets/X101-features/',
                        help='little data')
    ###########################################################################
    parser.add_argument('--dir_to_save_float16_feats', type=str, default='./Datasets/X101-features-float16/',
                        help='little data')
    ##########################################################################
